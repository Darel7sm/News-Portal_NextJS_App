...
import bannerImg from "@/assets/open ai.png";
import { Button } from "./ui/button";

const Banner = () => {
  return (
    <section className=" dark:bg-slate-800 dark:text-white bg-gray-100 py-8">
      <div className="max-w-7xl mx-auto grid max-lg:grid-cols-1 md:grid-cols-2 items-center gap-8 px-4 sm:px-6 lg:px-8 py-5">
